...
### Resonanzfrequenz
Das Wissen über die Resonanzfrequenz ist nicht nur wichtig wenn diese Bauteile in ganz ähnlicher Anordnung als Schwingkreis verwendet werden. Auch bei Hochpass und Tiefpassfiltern ist die Resonanzfrequenz wichtig. Auch wenn für Filter die Grenzfrequenz öfter herangezogen wird.  
Da es sich bei dieser Schaltung um eine Schaltung mit zwei Energiespeichern handelt, zwischen der die Energie hin und her Pendeln kann, ist dieses System schwingfähig und in der Lage bei Resonanz eine Resonanzüberhöhung zu erzeugen. Das bedeutet, dass die Amplitude am Ausgang größer als der Eingang ist. Es ist leicht vorstellbar, dass in solch einem Fall eine eventuell dahinter liegende Schaltung zerstört werden könnte. Daher gilt es die Resonanzüberhöhung meistens zu vermeiden.
...
Aus dem Bode-Diagramm kann das Verhalten des Filters, welches mathematisch in der Übertragungsfunktion beschrieben ist, grafisch abgelesen werden.  
...
Ob es zu einer Resonanzüberhöhung kommt, hängt davon ab, wie stark das System gedämpft ist. Bei einem Hochpass 2ter Ordnung ist die Dämpfung durch den Widerstand R maßgeblich bestimmt. 
